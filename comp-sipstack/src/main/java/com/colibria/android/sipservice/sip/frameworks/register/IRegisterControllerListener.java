 ...
 */
public interface IRegisterControllerListener {

    void setServiceRouteHeaderAddress(Address address);

    void activeStateReached();

    void initStateReached();

    List<RouteHeader> getInitialRouteSet();
