 ...
 */
public class SubscriptionState extends State<Signal, ClientSubscriptionBase> {


    public SubscriptionState(String name, boolean shouldBlock) {
        super(name, shouldBlock);
    }
    ...
    public void exit(ClientSubscriptionBase owner, boolean forReEnter) {
