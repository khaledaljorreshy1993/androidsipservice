...
/**
 * Wraps around UaCallTransition2
 */
public class UAgent2CallTransition extends Transition<Signal, UAgent2> {

    public UAgent2CallTransition(Condition<Signal, UAgent2> condition, State<Signal, UAgent2> state, State<Signal, UAgent2> exceptionState) {
        super(condition, state, exceptionState);
    }
}