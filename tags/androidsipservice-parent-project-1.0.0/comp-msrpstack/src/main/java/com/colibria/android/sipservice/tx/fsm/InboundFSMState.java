 ...
 */
public class InboundFSMState extends State<InboundFSMSignal, InboundFSM> {

    public InboundFSMState(String name) {
        super(name);
    }
    ...
    public void exit(InboundFSM owner, boolean forReEnter) {
        //void
    }
