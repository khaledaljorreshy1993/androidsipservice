 ...
 */
public class InboundFSMTransition extends Transition<InboundFSMSignal, InboundFSM> {

    public InboundFSMTransition(Condition<InboundFSMSignal, InboundFSM> condition, State<InboundFSMSignal, InboundFSM> targetState) {
