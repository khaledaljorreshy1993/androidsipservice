 ...
 */
public class LifeCycleFSMTransition extends Transition<LifeCycleFSMSignal, Participant> {

    public LifeCycleFSMTransition(LifeCycleFSMCondition condition, LifeCycleFSMState targetState) {
