...
* 
*/
package com.colibria.android.sipservice.sdp.core;
...
public abstract class GenericObjectList extends LinkedList implements
    ...
    public static boolean isMySubclass(Class other) {
        try {
            ...
            throw new RuntimeException("Could not handle", ex);
        }
    }
     ...
     * end of this list.
     *
     * @param objList topFlag </var> set to true to add items to top of list
     */
     ...
     * concatenation.
     *
     * @param objList topFlag </var> set to true to add items to top of list else
        ...
        while (hisIterator.hasNext()) {
            ...
            while (myIterator.hasNext()) {
                ...
                if (GenericObject.isMySubclass(myobj.getClass())
                    ...
                    break outer;
                else if (isMySubclass(myobj.getClass())
